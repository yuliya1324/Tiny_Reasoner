...
def composite_reward(response: str, ground_truth: str,
                      ...
                      length_penalty_weight: float = 0.001) -> float:
    """
    ...
    """
    base = format_shaped_reward(response, ground_truth, format_bonus)
